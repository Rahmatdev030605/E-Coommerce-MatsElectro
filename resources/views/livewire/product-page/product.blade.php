        ...
        <div class="px-4 py-4 mx-auto max-w-7xl lg:py-6 md:px-6">
            <div class="flex flex-wrap mb-24 -mx-3">
                <div class="w-full pr-2 lg:w-1/4 lg:block">
                    ...
                    @livewire('product-page.filter-category')
                    @livewire('product-page.filter-brand')
                    @livewire('product-page.filter-product-status')
                    @livewire('product-page.filter-price-range')
