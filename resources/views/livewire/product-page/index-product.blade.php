            ...
            <div class="flex flex-wrap mb-24 -mx-3">
                <div class="w-full pr-2 lg:w-1/4 lg:block">
                    ...
                    <div class="p-4 mb-5 bg-white border border-gray-200 dark:border-gray-900 dark:bg-gray-900">
                        ...
                        <ul>
                            @foreach ($categories as $category)
                                <li class="mb-4">
                                    <label for="{{ $category->slug }}" wire:key="{{ $category->id }}"
                    ...
                    <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                        ...
                        <ul>
                            @foreach ($brands as $brand)
                                <li class="mb-4">
                                    <label wire:key="{{ $brand->id }}" for="{{ $brand->slug }}"
                    ...
                    <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                        ...
                        <div class="w-16 pb-2 mb-6 border-b border-rose-600 dark:border-gray-400"></div>
                        <div>
                            <div class="font-bold text-sm text-green-400">{{ Number::currency($price_range, 'IDR') }}</div>
                            <input type="range" wire:model.live="price_range"
                                class="w-full h-1 mb-4 bg-blue-100 rounded appearance-none cursor-pointer"
                                max="50000000" value="100000" step="1000">
                            <div class="flex justify-between ">
                                <span class="inline-block text-[15px] font-bold text-blue-400 ">{{ Number::currency(100000, "IDR") }}</span>
                                <span class="inline-block text--[15px] font-bold text-blue-400 ">{{ Number::currency(50000000, "IDR") }}</span>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3" wire:key="{{ $product->id }}">
                                <div class="border border-gray-300 dark:border-gray-700">
                                    ...
                                    <div class="flex justify-center p-4 border-t border-gray-300 dark:border-gray-700">
                                        {{-- <button wire:click="resetCart()">Reset Cart</button> --}}
